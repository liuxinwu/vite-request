(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var handleLoading = function (isStart, requestKey, showLoadingFn) {
        var timeId;
        if (isStart) {
    ...
    var ViteRequest = /** @class */ (function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3:
                            ...
                            // 收集错误信息
                            collectError(this, error_1);
                            console.log(status_1, "status");
                            if (!(status_1 !== _customConfig.notPermissionCode)) return [3 /*break*/, 4];
                        ...
                        case 5:
                            _b.trys.push([5, 8, , 9]);
                            if (!_customConfig.refreshToken) return [3 /*break*/, 7];
        ...
        ViteRequest.prototype.handleBeforeRequest = function (config, customConfig, requestKey) {
            ...
            var _a = customConfig.isNeedToken, isNeedToken = _a === void 0 ? false : _a, _b = customConfig.isNeedLoading, isNeedLoading = _b === void 0 ? false : _b, setToken = customConfig.setToken, showLoadingFn = customConfig.showLoadingFn;
            // 处理 token
        ...
        ViteRequest.prototype.handleAfterRequest = function (customConfig, requestKey) {
            var _a = customConfig.isNeedLoading, isNeedLoading = _a === void 0 ? false : _a, showLoadingFn = customConfig.showLoadingFn;
            // 处理重复请求
            handleRepeat(requestKey, false);
            // 处理 Loading
