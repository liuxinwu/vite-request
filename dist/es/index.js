...
var ViteRequest = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        if (!(status_1 !== 401)) return [3 /*break*/, 4];
    ...
    ViteRequest.prototype.handleBeforeRequest = function (config, customConfig, requestKey) {
        ...
        var _a = customConfig.isNeedToken, isNeedToken = _a === void 0 ? false : _a, _b = customConfig.isNeedLoading, isNeedLoading = _b === void 0 ? false : _b, _handleToken = customConfig.handleToken;
        // 处理 token
